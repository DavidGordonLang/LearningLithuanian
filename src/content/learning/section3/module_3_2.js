  ...
  return {
    ...
    lessons: [
      ...
      // ── Lesson 1 — How Much Is It? ──────────────────────────────────────────
      {
        ...
        newLanguageLoad: "low",
        notes: {
          pattern: "Kiek tai kainuoja? is a useful general price question. When the item is named, Kiek kainuoja knyga? is often clearer. You can also hear Kokia kaina? — what is the price?",
          usage: [
        ...
        blocks: [
          {
            ...
            items: [
              ...
              { id: "pq2", lt: "Kiek kainuoja knyga?", en: "How much does the book cost?",   audioText: "Kiek kainuoja knyga", saveable: true, core: true },
              { id: "pq3", lt: "Kiek kainuoja ta knyga?",   en: "How much does that book cost?",   audioText: "Kiek kainuoja ta knyga",   saveable: true, core: true },
          ...
          },
          {
            ...
            prompt: { text: "Kiek kainuoja ta knyga?", audioText: "Kiek kainuoja ta knyga" },
            options: [
              { id: "a", text: "How much does the book cost?", isCorrect: false },
              { id: "b", text: "How much does that book cost?", isCorrect: true },
          ...
          },
          {
            ...
            prompt: { text: "How much does the book cost?" },
            tokens: [
              { id: "t1", text: "Kiek",      correctIndex: 0 },
              { id: "t2", text: "kainuoja",  correctIndex: 1 },
              { id: "t3", text: "knyga?",    correctIndex: 2 },
              { id: "t4", text: "tas",       isDistractor: true },
            ],
            answerText: "Kiek kainuoja knyga?",
          },
          {
  id: "s3m2l1_b6_v2",
  type: "scenario_v2",
  ...
  steps: [
    {
      ...
      speakerLabel: "Seller",
      speakerText: "Laba diena!",
      sceneDirection: "You pick up the hat you want and hold it up to Tomas.",
      learnerPrompt: "Ask how much it costs.",
      options: [
        {
          id: "a",
          text: "Laba diena! Kiek tai kainuoja?",
          result: "best",
          progresses: true,
        },
        {
          ...
          result: "wrong",
          feedback: "Knyga means book. You're holding up the hat, so ask the price of the item you're showing him.",
          progresses: false,
        },
        {
          id: "c",
          text: "Ar jūs kalbate angliškai?",
          result: "wrong",
          feedback: "That does not answer your goal here. Ask the price of the item you're holding up.",
          progresses: false,
        }
      ],
    },
    {
      ...
      help: {
        levels: [
          ...
          {
            speakerText: "It costs fifteen euros.",
            spokenLanguage: "en",
            audio: false,
          },
        ],
        ...
        blocks: [
          {
            ...
            items: [
              ...
              { id: "pr3", lt: "Pigu",  en: "Cheap / inexpensive",  audioText: "Pigu",  saveable: true, core: true },
    ...
    },
    {
      ...
      help: {
        levels: [
          ...
          {
            speakerText: "It costs twenty euros.",
            spokenLanguage: "en",
            audio: false,
          },
        ],
        ...
        blocks: [
          ...
          },
          {
            ...
            options: [
              ...
              { id: "b", text: "Could I get the bill, please?", isCorrect: true },
  ...
  steps: [
    {
      ...
      help: {
        levels: [
          ...
          {
            speakerText: "Is everything okay?",
            spokenLanguage: "en",
            audio: false,
          },
        ],
      ...
      // ── Module 3.2 Checkpoint ────────────────────────────────────────────────
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            type: "build_phrase",
            title: "Build the phrase",
            prompt: { text: "Could I get the bill, please?" },
            tokens: [
              { id: "t1", text: "Ar",         correctIndex: 0 },
              { id: "t2", text: "galėčiau",   correctIndex: 1 },
              { id: "t3", text: "gauti",      correctIndex: 2 },
              { id: "t4", text: "sąskaitą,",  correctIndex: 3 },
              { id: "t5", text: "prašau?",    correctIndex: 4 },
              { id: "t6", text: "Noriu",      isDistractor: true },
              { id: "t7", text: "kortele",    isDistractor: true },
            ],
            answerText: "Ar galėčiau gauti sąskaitą, prašau?",
          },
          {
  id: "s3m2c_b6_v2",
  type: "scenario_v2",
        ...
        },
        {
...
},
          {
            ...
            pairs: [
              ...
              { id: "m2",  lt: "Kiek kainuoja knyga?",       en: "How much does the book cost?",   audioText: "Kiek kainuoja knyga" },
              ...
              { id: "m13", lt: "Pigu",                 en: "Cheap / inexpensive",          audioText: "Pigu" },
              ...
              { id: "m17", lt: "Ar galėčiau gauti sąskaitą, prašau?",          en: "Could I get the bill, please?",               audioText: "Ar galėčiau gauti sąskaitą, prašau?" },
