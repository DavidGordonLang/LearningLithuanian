...
export default function createModule_5_4(profile = {}) {
  ...
  steps: [
    ...
    },
    {
      ...
      sceneDirection: "Rasa says: go straight, then turn left.",
      learnerPrompt: "Confirm the route you heard, then ask whether it is far.",
      help: {
        levels: [
      ...
      options: [
        { id: "a", text: "Tiesiai, paskui kairėn? Ar toli?", result: "best", progresses: true },
        { id: "b", text: "Tiesiai, paskui dešinėn? Ar toli?", result: "wrong", feedback: "She said left — kairėn — not right.", progresses: false },
        { id: "c", text: "Kairėn, paskui tiesiai? Ar toli?", result: "wrong", feedback: "The order is reversed. She said straight first, then left.", progresses: false },
      ],
    },
    {
      id: "step_3",
      ...
      sceneDirection: "Ten minutes is fine for you, so you will walk.",
  ...
  steps: [
    ...
    },
    {
      ...
      sceneDirection: "It is far enough that you decide to take the bus.",
      learnerPrompt: "Ask for the bus stop you need next.",
      options: [
        { id: "a", text: "Suprantu. Kur yra autobusų stotelė?", result: "best", progresses: true },
        { id: "b", text: "Suprantu. Kur yra autobusų stotis?", result: "wrong", feedback: "You need the nearby bus stop — stotelė — not the bus station.", progresses: false },
    ...
    },
    {
      ...
      sceneDirection: "Rasa points to the nearby bus stop on the right.",
      learnerPrompt: "Confirm the direction you heard and thank her.",
      options: [
        { id: "a", text: "Dešinėn? Puiku, ačiū labai.", result: "best", progresses: true },
        { id: "b", text: "Kairėn? Puiku, ačiū labai.", result: "wrong", feedback: "She said right — dešinėn — not left.", progresses: false },
        { id: "c", text: "Tiesiai? Puiku, ačiū labai.", result: "wrong", feedback: "She pointed to the right, not straight ahead.", progresses: false },
      ],
