...
export default function createModule_5_3(profile = {}) {
  ...
  type: "scenario_v2",
  title: "Going home",
  description: "You are leaving the city centre and heading home. Rokas asks where you are going, then asks whether it is far.",
  sceneIntro: "You are leaving the city centre and heading home. Rokas asks where you are going, then asks whether it is far.",
  location: "street",
  userRole: "colleague",
  register: "polite_friendly",
  goal: "Distinguish going home from being at home or coming from home, then retrieve distance language.",
  focus: ["Einu namo", "namuose", "iš namų", "netoli"],
  participants: [
  ...
  steps: [
    ...
    },
    {
      ...
      speakerLabel: "Colleague",
      speakerText: "Ar toli?",
      sceneDirection: "Home is nearby: it is a ten-minute walk.",
      ...
      options: [
        ...
        { id: "b", text: "Taip, tai labai toli. Dešimt minučių.", result: "wrong", feedback: "The scene says home is nearby.", progresses: false },
