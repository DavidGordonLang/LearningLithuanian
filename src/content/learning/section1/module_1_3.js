  ...
  return {
    ...
    lessons: [
      ...
      // ── Lesson 1 ────────────────────────────────────────────────────────────
      {
        ...
        newLanguageLoad: "low",
        notes: {
          pattern: "Nesuprantu and suprantu are the same verb — ne- makes it negative. This is one of the highest-value phrases in the whole course.",
          usage: [
            ...
            "Ar suprantate? — Do you understand? (formal, someone asking you)",
          ],
        },
        blocks: [
          {
          ...
          },
          {
            ...
            steps: [
              ...
              },
              {
                id: "step_2",
                actor: "other",
                text: "Gerai. Ar suprantate?",
                audioText: "Gerai. Ar suprantate",
                options: [
                  { id: "a", text: "Taip, suprantu.", isCorrect: true },
            ...
            steps: [
              {
                ...
                options: [
                  { id: "a", text: "Laba diena! Taip, prašau. Ką tai reiškia?", isCorrect: true },
                  { id: "b", text: "Ne, ačiū", isCorrect: false },
                  { id: "c", text: "Viso gero", isCorrect: false },
                ],
              },
      ...
      // ── Lesson 4 ────────────────────────────────────────────────────────────
      {
        ...
        notes: {
          ...
          usage: [
            ...
            "Taip, šiek tiek — Yes, a little",
            "Ne — No",
            "Aš kalbu šiek tiek lietuviškai — I speak a little Lithuanian",
            "Šiek tiek — A little (useful standalone word)",
          ],
        },
        blocks: [
          {
            ...
            items: [
              ...
              { id: "lb2", lt: "Taip, šiek tiek", en: "Yes, a little", audioText: "Taip, šiek tiek", saveable: true, core: true },
              { id: "lb3", lt: "Ne", en: "No", audioText: "Ne", saveable: true, core: false },
              { id: "lb4", lt: "Aš kalbu šiek tiek lietuviškai", en: "I speak a little Lithuanian", audioText: "Aš kalbu šiek tiek lietuviškai", saveable: true, core: true },
              { id: "lb5", lt: "Šiek tiek", en: "A little", audioText: "Šiek tiek", saveable: true, core: true },
            ],
          },
          {
            id: "s1m3l4_b2",
          ...
          },
          {
            ...
            type: "build_phrase",
            title: "Build the phrase",
            prompt: { text: "I speak a little Lithuanian" },
            tokens: [
              { id: "t1", text: "Aš", correctIndex: 0 },
              { id: "t2", text: "kalbu", correctIndex: 1 },
              { id: "t3", text: "šiek", correctIndex: 2 },
              { id: "t4", text: "tiek", correctIndex: 3 },
              { id: "t5", text: "lietuviškai", correctIndex: 4 },
              { id: "t6", text: "angliškai", isDistractor: true },
            ],
            answerText: "Aš kalbu šiek tiek lietuviškai",
          },
          {
            id: "s1m3l4_b6",
            type: "speak_self_check",
          ...
          },
          {
            ...
            steps: [
              ...
              },
              {
                ...
                options: [
                  { id: "a", text: "Ačiū! Aš kalbu šiek tiek lietuviškai.", isCorrect: true },
                  { id: "b", text: "Nesuprantu", isCorrect: false },
                  { id: "c", text: "Dar kartą, prašau", isCorrect: false },
                ],
              },
      ...
      // ── Checkpoint ────────────────────────────────────────────────────────
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            feedback: { correct: "Dar kartą, prašau — one more time please. The right tool when you nearly got it." },
          },
          {
            id: "s1m3c_b9",
            type: "scenario_chain",
            title: "Conversation",
            description: "You've just arrived in Vilnius. A local approaches you at the bus stop to help — use everything from Module 1.3 and earlier.",
            steps: [
              {
                id: "step_1",
                actor: "other",
                text: "Laba diena! Aš esu Rokas. Ar jūs iš užsienio?",
                audioText: "Laba diena. Aš esu Rokas. Ar jūs iš užsienio",
                options: [
                  { id: "a", text: "Viso gero!", isCorrect: false },
                  { id: "b", text: `Laba diena! Mano vardas ${userNameSafe}. Taip, ${userFromPhrase}.`, isCorrect: true },
                  { id: "c", text: "Ne, ačiū", isCorrect: false },
                ],
              },
              {
                ...
                options: [
                  { id: "a", text: "Aš kalbu šiek tiek lietuviškai.", isCorrect: true },
                  { id: "b", text: "Taip, suprantu!", isCorrect: false },
              ...
              },
              {
                id: "step_3",
                actor: "other",
                text: "Gerai! Autobusų stotelė yra už kampo.",
                audioText: "Gerai. Autobusų stotelė yra už kampo",
                options: [
                  { id: "a", text: "Suprantu! Ačiū", isCorrect: false },
                  { id: "b", text: "Ačiū labai!", isCorrect: false },
                  { id: "c", text: "Nesuprantu. Prašau kalbėkite lėčiau.", isCorrect: true },
                ],
              },
              {
                id: "step_4",
                actor: "other",
                text: "Autobusų stotelė — bus stop — yra ten.",
                audioText: "Autobusų stotelė yra ten",
                options: [
                  { id: "a", text: "Ką tai reiškia angliškai?", isCorrect: false },
                  { id: "b", text: "Ah! Suprantu. Ačiū labai!", isCorrect: true },
                  { id: "c", text: "Dar kartą, prašau", isCorrect: false },
                ],
              },
              {
                ...
                options: [
                  { id: "a", text: "Nesuprantu", isCorrect: false },
                  { id: "b", text: "Iki! Malonu susipažinti.", isCorrect: true },
                  { id: "c", text: "Atsiprašau", isCorrect: false },
                ],
              },
            ],
