      ...
      // ── Lesson 1 — I Want… ───────────────────────────────────────────────────
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            prompt: "Say: I want soup",
            targetText: "Noriu sriubos",
            audioText: "Noriu sriubos",
          },
          {
  id: "s4m1l1_b5_v2",
  type: "scenario_v2",
  ...
  steps: [
    {
      ...
      supportText: "Good day! What would you like? — a slightly more formal service phrasing.",
    ...
    },
    {
      ...
      speakerId: "local",
      speakerLabel: "Local",
      speakerText: "Žinoma. Moment.",
      supportText: "Of course. One moment.",
      sceneDirection: "The conversation continues.",
      learnerPrompt: "Choose the most natural response.",
      options: [
        {
  ...
  steps: [
    ...
    },
    {
      ...
      options: [
        {
          id: "a",
          text: "Nesuprantu. Prašau kalbėkite lėčiau.",
          result: "wrong",
          feedback: "This does not fit the situation. Choose the response that matches the speaker.",
          progresses: false,
        },
