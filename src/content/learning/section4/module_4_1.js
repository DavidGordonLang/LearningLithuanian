      ...
      // ── Lesson 1 — I Want… ───────────────────────────────────────────────────
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            type: "scenario_chain",
            title: "Conversation",
            description: "You stop at a café counter. Order a coffee, ask the price, and pay.",
            steps: [
              {
                id: "step_1",
                actor: "other",
                ...
                options: [
                  ...
                  { id: "b", text: "Laba diena! Noriu kavos, prašau.", en: "Good day! I want coffee, please.", isCorrect: true },
              ...
              },
              {
                ...
                helperText: "Yes, of course. Here you go.",
                options: [
      ...
      // ── Lesson 2 — I Would Like… ─────────────────────────────────────────────
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            type: "scenario_chain",
            title: "Conversation",
            description: "You walk into a café in Vilnius. Order politely, ask the price, and pay.",
            steps: [
              {
                id: "step_1",
                actor: "other",
              ...
              },
              {
                id: "step_2",
                actor: "other",
                text: "Žinoma. Ar dar ko norėtumėte?",
                audioText: "Žinoma. Ar dar ko norėtumėte",
              ...
              },
              {
                ...
                options: [
                  { id: "a", text: "Per brangu.", isCorrect: false },
                  { id: "b", text: "Gerai. Ar galima mokėti kortele?", en: "OK. Can I pay by card?", isCorrect: true },
      ...
      // ── Lesson 3 — This / That, Please ───────────────────────────────────────
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            type: "scenario_chain",
            title: "Conversation",
            description: "You're at a bakery counter. Point to what you want and check the price.",
            steps: [
              {
                id: "step_1",
                actor: "other",
                text: "Laba diena! Kurio norite?",
                audioText: "Laba diena! Kurio norite",
                helperText: "Good day! Which one would you like?",
                options: [
                  { id: "a", text: "Viso gero.", isCorrect: false },
                  { id: "b", text: "Šito, prašau.", en: "This one, please.", isCorrect: true },
                  { id: "c", text: "Ar turite kavos?", isCorrect: false },
                ],
              },
              {
                id: "step_2",
                actor: "other",
                text: "Šito? Gerai. Ar dar norite ko?",
                audioText: "Šito? Gerai. Ar dar norite ko",
                helperText: "This one? Fine. Would you like anything else?",
                options: [
                  { id: "a", text: "Taip, labai.", isCorrect: false },
                  { id: "b", text: "Ne, ačiū. Kiek šitas kainuoja?", en: "No, thank you. How much is this one?", isCorrect: true },
                  { id: "c", text: "Nesuprantu.", isCorrect: false },
                ],
              },
              {
                ...
                text: "Du eurai.",
                audioText: "Du eurai",
                helperText: "Two euros.",
                options: [
                  { id: "a", text: "Per brangu.", isCorrect: false },
                  { id: "b", text: "Gerai. Prašom.", en: "OK. Here you go.", isCorrect: true },
                  { id: "c", text: "Ar galima mokėti kortele?", isCorrect: false },
                ],
              },
              {
                id: "step_4",
      ...
      // ── Module 4.1 Checkpoint ─────────────────────────────────────────────────
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            type: "scenario_chain",
            title: "Conversation",
            description: "You stop at a café kiosk with a colleague. Order for both of you, check the price, pay, and close.",
            steps: [
              {
                id: "step_1",
                actor: "other",
                ...
                options: [
                  { id: "a", text: "Nesuprantu.", isCorrect: false },
                  { id: "b", text: "Laba diena! Vieną kavą ir dvi arbatas, prašau.", en: "Good day! One coffee and two teas, please.", isCorrect: true },
                  { id: "c", text: "Kur yra tualetas?", isCorrect: false },
                ],
              },
              {
                id: "step_2",
                actor: "other",
                text: "Vieną kavą ir dvi arbatas. Ar dar ko norite?",
                audioText: "Vieną kavą ir dvi arbatas. Ar dar ko norite",
                helperText: "One coffee and two teas. Anything else?",
                options: [
              ...
              },
              {
                ...
                options: [
                  { id: "a", text: "Ne, neturiu grynųjų.", isCorrect: false },
