      ...
      // ── Lesson 1 — Are You Hungry? / Are You Thirsty? ────────────────────────
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            type: "scenario_chain",
            title: "Conversation",
            description: "You and a friend are deciding whether to stop for food. You're both hungry.",
            steps: [
              {
                id: "step_1",
                actor: "other",
                ...
                options: [
                  ...
                  { id: "b", text: "Taip, aš alkanas. Ir noriu gerti.", en: "Yes, I'm hungry. And I'm thirsty.", isCorrect: true },
              ...
              },
              {
                id: "step_2",
                actor: "other",
                text: "Aš irgi! Kur einame?",
                audioText: "Aš irgi! Kur einame",
                helperText: "Me too! Where are we going?",
                options: [
                  { id: "a", text: "Kur yra tualetas?", isCorrect: false },
                  { id: "b", text: "Gal į kavinę?", en: "Maybe to the café?", isCorrect: true },
              ...
              },
              {
                ...
                actor: "other",
                text: "Puiku! Eikime.",
                audioText: "Puiku! Eikime",
                helperText: "Great! Let's go.",
                options: [
                  { id: "a", text: "Nesuprantu.", isCorrect: false },
                  { id: "b", text: "Gerai! Dabar?", en: "OK! Now?", isCorrect: true },
                  { id: "c", text: "Ne, vėliau.", isCorrect: false },
                ],
              },
              {
                id: "step_4",
                actor: "other",
                text: "Taip, dabar. Laba diena! Ko norėtumėte?",
                audioText: "Taip, dabar. Laba diena! Ko norėtumėte",
                helperText: "Yes, now. Good day! What would you like?",
                options: [
                  { id: "a", text: "Man reikia pagalbos.", isCorrect: false },
                  { id: "b", text: "Laba diena! Norėčiau kavos, prašau.", en: "Good day! I would like coffee, please.", isCorrect: true },
      ...
      // ── Lesson 2 — Do You Want…? ─────────────────────────────────────────────
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            type: "scenario_chain",
            title: "Conversation",
            description: "You offer a colleague something to drink and find out what they want.",
            steps: [
              {
                id: "step_1",
                actor: "other",
                ...
                options: [
                  ...
                  { id: "c", text: "Kaip sekasi?", isCorrect: false },
                ],
              },
              {
                id: "step_2",
                ...
                options: [
                  ...
                  { id: "b", text: "Žinoma. Vieną kavą su pienu.", en: "Of course. One coffee with milk.", isCorrect: true },
                  { id: "c", text: "Grynaisiais ar kortele?", isCorrect: false },
                ],
              },
              {
                id: "step_3",
                ...
                options: [
                  { id: "a", text: "Viso gero.", isCorrect: false },
                  { id: "b", text: "Prašom! Ar gerai?", en: "Here you go! Is it OK?", isCorrect: true },
                  { id: "c", text: "Nesuprantu.", isCorrect: false },
                ],
              },
              {
                id: "step_4",
                actor: "other",
                text: "Taip, labai gerai! Ar dar nori kavos?",
                audioText: "Taip, labai gerai! Ar dar nori kavos",
                helperText: "Yes, very good! Do you want more coffee?",
                options: [
                  { id: "a", text: "Ne, ačiū.", isCorrect: false },
                  { id: "b", text: "Ar dar nori kavos?", en: "Do you want more coffee?", isCorrect: true },
      ...
      // ── Lesson 3 — Let's Eat / Let's Drink / Let's Go ────────────────────────
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            type: "scenario_chain",
            title: "Conversation",
            description: "You suggest going for a coffee with a friend. They agree and you head out.",
            steps: [
              {
                id: "step_1",
                actor: "other",
              ...
              },
              {
                id: "step_2",
                actor: "other",
                text: "Puiku! Dabar ar vėliau?",
                audioText: "Puiku! Dabar ar vėliau",
                helperText: "Great! Now or later?",
                options: [
                  { id: "a", text: "Gal vėliau.", isCorrect: false },
                  { id: "b", text: "Dabar! Išgerkime kavos.", en: "Now! Let's drink coffee.", isCorrect: true },
                  { id: "c", text: "Kur einame?", isCorrect: false },
                ],
              },
              {
                id: "step_3",
                actor: "other",
                text: "Gerai! Eikime.",
                audioText: "Gerai! Eikime",
                helperText: "OK! Let's go.",
                options: [
                  { id: "a", text: "Atsiprašau.", isCorrect: false },
                  { id: "b", text: "Ačiū! Pavalgykime irgi.", en: "Thank you! Let's eat too.", isCorrect: true },
                  { id: "c", text: "Nesuprantu.", isCorrect: false },
                ],
              },
              {
                id: "step_4",
                actor: "other",
                text: "Žinoma! Kavinė yra ten.",
                audioText: "Žinoma! Kavinė yra ten",
                helperText: "Of course! The café is over there.",
                options: [
                  { id: "a", text: "Kur yra kavinė?", isCorrect: false },
                  { id: "b", text: "Puiku! Eikime.", en: "Great! Let's go.", isCorrect: true },
                  { id: "c", text: "Viso gero.", isCorrect: false },
                ],
              },
            ],
      ...
      // ── Lesson 4 — For Me / For You / For Us ─────────────────────────────────
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            type: "scenario_chain",
            title: "Conversation",
            description: "You're at a café with a colleague. Order for both of you using man and tau.",
            steps: [
              {
                id: "step_1",
                actor: "other",
                ...
                options: [
                  { id: "a", text: "Nesuprantu.", isCorrect: false },
                  { id: "b", text: "Laba diena! Man kavos ir tau arbatos, prašau.", en: "Good day! Coffee for me and tea for you, please.", isCorrect: true },
                  { id: "c", text: "Viso gero.", isCorrect: false },
                ],
              },
              {
                id: "step_2",
                actor: "other",
                text: "Žinoma. Kam kava?",
                audioText: "Žinoma. Kam kava",
                helperText: "Of course. Who is the coffee for?",
                options: [
              ...
              },
              {
                id: "step_3",
                actor: "other",
                text: "Prašom. Ar dar ko norite?",
                audioText: "Prašom. Ar dar ko norite",
                helperText: "Here you go. Anything else?",
                options: [
                  { id: "a", text: "Taip, dar vieną.", isCorrect: false },
                  { id: "b", text: "Ne, ačiū. Kiek tai kainuoja?", en: "No, thank you. How much is it?", isCorrect: true },
                  { id: "c", text: "Nesuprantu.", isCorrect: false },
                ],
              },
              {
      ...
      // ── Lesson 5 — This Is Good ───────────────────────────────────────────────
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            type: "scenario_chain",
            title: "Conversation",
            description: "You and a friend are eating together. Comment on the food and then pay.",
            steps: [
              {
                id: "step_1",
                actor: "other",
                text: "Prašom! Ar gerai?",
                audioText: "Prašom! Ar gerai",
                helperText: "Here you go! Is it OK?",
                options: [
                  { id: "a", text: "Per karšta.", isCorrect: false },
                  { id: "b", text: "Ačiū! Labai gerai.", en: "Thank you! Very good.", isCorrect: true },
                  { id: "c", text: "Nesuprantu.", isCorrect: false },
                ],
              },
              {
              ...
              },
              {
                id: "step_4",
                actor: "other",
                text: "Žinoma. Septyni eurai. Grynaisiais ar kortele?",
                audioText: "Žinoma. Septyni eurai. Grynaisiais ar kortele",
                helperText: "Of course. Seven euros. Cash or card?",
                options: [
                  { id: "a", text: "Per brangu.", isCorrect: false },
                  { id: "b", text: "Kortele, prašau.", en: "By card, please.", isCorrect: true },
                  { id: "c", text: "Nesuprantu.", isCorrect: false },
