      ...
      // ── Lesson 1 — I Don't Want… ──────────────────────────────────────────────
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            type: "scenario_chain",
            title: "Conversation",
            description: "You are offered an item you don't want.",
            steps: [
              {
                id: "step_1",
                actor: "other",
                text: "Ar norite šito?",
                audioText: "Ar norite šito",
                helperText: "Would you like this?",
                options: [
              ...
              },
              {
                ...
                actor: "other",
                text: "Ar su pienu?",
                audioText: "Ar su pienu",
                helperText: "With milk?",
                options: [
                  { id: "a", text: "Taip, su pienu.", isCorrect: false },
                  { id: "b", text: "Ne, be pieno, prašau.", en: "No, without milk, please.", isCorrect: true },
      ...
      // ── Lesson 2 — I Don't Eat… ───────────────────────────────────────────────
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            type: "scenario_chain",
            title: "Conversation",
            description: "A waiter asks about your dietary preferences.",
            steps: [
              {
                id: "step_1",
                actor: "other",
                text: "Ar valgote mėsą?",
                audioText: "Ar valgote mėsą",
              ...
              },
              {
                id: "step_2",
                actor: "other",
                text: "Suprantu. Be mėsos — gerai.",
                audioText: "Suprantu. Be mėsos — gerai",
                helperText: "I understand. Without meat — OK.",
                options: [
      ...
      // ── Lesson 3 — This Is Not What I Ordered ────────────────────────────────
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            type: "scenario_chain",
            title: "Conversation",
            description: "A waiter brings the wrong drink. You correct it politely.",
            steps: [
              {
                id: "step_1",
                actor: "other",
                text: "Prašom.",
                audioText: "Prašom",
                helperText: "Here you go — but it's the wrong drink.",
                options: [
                  { id: "a", text: "Ačiū!", isCorrect: false },
                  { id: "b", text: "Atsiprašau — čia ne tai, ką užsakiau.", en: "Excuse me — this is not what I ordered.", isCorrect: true },
              ...
              },
              {
                id: "step_2",
                actor: "other",
                text: "Atsiprašau. Ką užsakėte?",
                audioText: "Atsiprašau. Ką užsakėte",
                helperText: "I'm sorry. What did you order?",
                options: [
                  { id: "a", text: "Ne šitą.", isCorrect: false },
                  { id: "b", text: "Aš užsakiau kavą, ne arbatą.", en: "I ordered coffee, not tea.", isCorrect: true },
                  { id: "c", text: "Nesuprantu.", isCorrect: false },
                ],
              },
              {
                id: "step_3",
                actor: "other",
                text: "Labai atsiprašau. Tuoj atnešiu.",
                audioText: "Labai atsiprašau. Tuoj atnešiu",
                helperText: "I'm very sorry. I'll bring it right away.",
                options: [
                  { id: "a", text: "Čia ne tai, ką užsakiau.", isCorrect: false },
      ...
      // ── Lesson 4 — Can You Change It? ────────────────────────────────────────
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            type: "scenario_chain",
            title: "Conversation",
            description: "Your drink is wrong. You identify the problem and ask for a fix.",
            steps: [
              {
                id: "step_1",
                actor: "other",
                ...
                options: [
                  { id: "a", text: "Ačiū!", isCorrect: false },
                  { id: "b", text: "Atsiprašau — čia ne tai, ką užsakiau. Ar galite pakeisti?", en: "Excuse me — this is not what I ordered. Can you change it?", isCorrect: true },
                  { id: "c", text: "Labai gerai.", isCorrect: false },
                ],
              },
              {
                id: "step_2",
                actor: "other",
                text: "Labai atsiprašau. Ko norėjote?",
                audioText: "Labai atsiprašau. Ko norėjote",
                helperText: "I'm very sorry. What did you want?",
                options: [
                  { id: "a", text: "Čia ne tai.", isCorrect: false },
                  { id: "b", text: "Kavos be pieno, prašau.", en: "Coffee without milk, please.", isCorrect: true },
                  { id: "c", text: "Nesuprantu.", isCorrect: false },
                ],
              },
              {
                ...
                options: [
                  { id: "a", text: "Kitą, prašau.", isCorrect: false },
                  { id: "b", text: "Ačiū labai!", en: "Thank you very much!", isCorrect: true },
                  { id: "c", text: "Ko norite?", isCorrect: false },
                ],
              },
      ...
      // ── Lesson 5 — Too Hot / Too Cold / Not Good ──────────────────────────────
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            type: "scenario_chain",
            title: "Conversation",
            description: "Your drink is too hot. Then you get a replacement that is fine.",
            steps: [
              {
                id: "step_1",
                actor: "other",
                ...
                options: [
                  { id: "a", text: "Labai gerai!", isCorrect: false },
              ...
              },
              {
                id: "step_2",
                actor: "other",
                text: "Atsiprašau. Palaukite.",
                audioText: "Atsiprašau. Palaukite",
                helperText: "I'm sorry. Wait a moment.",
                options: [
                  { id: "a", text: "Sąskaitą, prašau.", isCorrect: false },
                  { id: "b", text: "Gerai, ačiū.", en: "OK, thank you.", isCorrect: true },
                  { id: "c", text: "Per šalta.", isCorrect: false },
                ],
              },
              {
                id: "step_3",
      ...
      // ── Module 4.3 Checkpoint ─────────────────────────────────────────────────
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            type: "scenario_chain",
            title: "Conversation",
            description: "You receive the wrong order. You identify the problem, explain what you ordered, and ask for a fix.",
            steps: [
              {
                id: "step_1",
                actor: "other",
              ...
              },
              {
                ...
                options: [
                  { id: "a", text: "Ne šitą.", isCorrect: false },
                  { id: "b", text: "Aš užsakiau kavą be pieno.", en: "I ordered coffee without milk.", isCorrect: true },
                  { id: "c", text: "Nesuprantu.", isCorrect: false },
                ],
              },
              {
                id: "step_3",
                actor: "other",
                text: "Žinoma. Ar galite palaukti minutę?",
                audioText: "Žinoma. Ar galite palaukti minutę",
                helperText: "Of course. Can you wait a minute?",
                options: [
                  { id: "a", text: "Sąskaitą, prašau.", isCorrect: false },
                  { id: "b", text: "Taip, galiu. Ačiū.", en: "Yes, I can. Thank you.", isCorrect: true },
                  { id: "c", text: "Ko norite?", isCorrect: false },
                ],
              },
              {
                id: "step_4",
                actor: "other",
                text: "Prašom. Kava be pieno.",
                audioText: "Prašom. Kava be pieno",
                helperText: "Here you go. Coffee without milk.",
                options: [
                  { id: "a", text: "Per karšta.", isCorrect: false },
