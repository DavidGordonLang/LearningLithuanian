      ...
      // ── Lesson 5 — Too Cold / Too Hot / Not Good ──────────────────────────────
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            type: "scenario_v2",
            title: "Conversation",
            description: "Your coffee arrives too cold. Explain the problem, ask for another one after the server apologises, then finish the interaction and pay.",
            sceneIntro: "Your coffee arrives too cold. Explain the problem, ask for another one after the server apologises, then finish the interaction and pay.",
            location: "café",
            userRole: "customer",
            register: "polite_service",
            goal: "Say the coffee is too cold, then ask for a replacement at the natural point in the conversation.",
            focus: ["Per šalta", "Ar galite atnešti kitą?", "payment"],
            participants: [
              {
                id: "server",
                label: "Server",
            ...
            steps: [
              {
                ...
                sceneDirection: "You take a sip and notice that the coffee is cold.",
                learnerPrompt: "Acknowledge the coffee.",
                options: [
                  { id: "a", text: "Ačiū!", result: "best", progresses: true },
                  { id: "b", text: "Ačiū.", result: "acceptable", feedback: "A simple thank-you is completely natural here.", progresses: true },
                  { id: "c", text: "Čia ne tai, ką užsisakiau.", result: "wrong", feedback: "The coffee is what you ordered; the problem is its temperature.", progresses: false },
                ],
              },
              {
                id: "step_2",
                ...
                options: [
                  ...
                  { id: "c", text: "Taip, labai gerai!", result: "wrong", feedback: "The coffee is too cold, so saying everything is very good does not fit.", progresses: false },
                ],
              },
              {
                id: "step_3",
                ...
                options: [
                  ...
                  { id: "c", text: "Ačiū labai.", result: "wrong", feedback: "The server has apologised, but you still need to ask for the replacement.", progresses: false },
                ],
              },
              {
                id: "step_4",
                ...
                sceneDirection: "Rasa takes the cold coffee away and goes to replace it.",
                learnerPrompt: "Acknowledge politely.",
                options: [
                  { id: "a", text: "Ačiū.", result: "best", progresses: true },
                  { id: "b", text: "Gerai, ačiū.", result: "acceptable", feedback: "Also natural here.", progresses: true },
                  { id: "c", text: "Viso gero.", result: "wrong", feedback: "The interaction is not finished yet.", progresses: false },
                ],
              },
              {
                id: "step_5",
                ...
                options: [
                  { id: "a", text: "Taip, labai gerai! Ačiū.", result: "best", progresses: true },
                  { id: "b", text: "Taip, ačiū.", result: "acceptable", feedback: "A shorter natural confirmation.", progresses: true },
                  { id: "c", text: "Ne, per šalta.", result: "wrong", feedback: "The replacement coffee is fine now.", progresses: false },
                ],
              },
              {
                id: "step_6",
                ...
                sceneDirection: "Later, you have finished the coffee and are ready to pay.",
                learnerPrompt: "Say no thanks and ask for the bill.",
                options: [
                  { id: "a", text: "Ne, ačiū. Sąskaitą, prašau.", result: "best", progresses: true },
                  { id: "b", text: "Sąskaitą, prašau.", result: "acceptable", feedback: "Shorter, but still natural in this context.", progresses: true },
              ...
              },
              {
                ...
                options: [
                  { id: "a", text: "Grynaisiais, prašau.", result: "best", progresses: true },
                  { id: "b", text: "Kortele, prašau.", result: "best", progresses: true },
                  { id: "c", text: "Per brangu.", result: "wrong", feedback: "You have already finished the coffee and are paying the bill.", progresses: false },
                ],
              },
            ],
          },
