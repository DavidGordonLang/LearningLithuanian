...
export default function createModule_4_3(profile = {}) {
      ...
      // ── Lesson 4 — Can You Change It? ────────────────────────────────────────
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            type: "best_response",
            title: "Choose the best response",
            prompt: { text: "You ordered coffee with milk, but you were brought tea with lemon. You've already said čia ne tai, ką užsisakiau. How do you ask for a replacement?" },
            options: [
  ...
  type: "scenario_v2",
  title: "Conversation",
  description: "You ordered coffee with milk, but the server brings tea with lemon. Identify the problem, ask for a change, and confirm what you want.",
  sceneIntro: "You ordered coffee with milk, but the server brings tea with lemon. Identify the problem, ask for a change, and confirm what you want.",
  location: "real-life exchange",
  userRole: "learner",
  register: "polite_neutral",
  ...
  steps: [
    {
      ...
      sceneDirection: "You ordered coffee with milk, but Rasa has brought tea with lemon.",
      learnerPrompt: "Explain that this is not what you ordered and ask for it to be changed.",
      options: [
        {
          id: "a",
          text: "Ačiū!",
