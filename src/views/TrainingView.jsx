...
import ExamPrepHome from "./trainin// src/views/TrainingView.jsx
import React, { useMemo, useState } from "react";
import TrainingHome from "./training/TrainingHome";
import LearningHome from "./training/LearningHome";
import LearningSectionView from "./training/LearningSectionView";
  ...
  if (screen === "learningLesson") {
    return (
      <LearningLessonView
        ...
        userId={user?.id}
        onBack={() => {
          // When returning to module view (browse path), keep selectedLessonId
          // so the module view knows which lesson was being replayed.
          // Only clear when going all the way to home.
